...
% and thatthey are stored here /Users/zagnew/Cereb_data/cTBS/data_analysis

gp.precereb=load('patient_pre');
gp.postcereb=load('patient_post');
gp.presham=load('control_pre');
gp.postsham=load('control_post');
gp.prebeh=load('post_beh_data')
gp.postbeh=load('post_beh_data')
...
for isubj=1:13 %length(gp.postcereb.patient_dat.pert_resp)
    ...
    gp.prebeh.control_dat.pert_resp(isubj).cents4comp(1).temp.dat=-gp.prebeh.pre_beh_data.control_dat.control_dat.pert_resp(isubj).cents4comp(1).pitch_in.dat{1};
    gp.prebeh.control_dat.pert_resp(isubj).cents4comp(1).abspitch_in.dat = [gp.prebeh.control_dat.pert_resp(isubj).cents4comp(1).temp.dat ; gp.prebeh.control_dat.pert_resp(isubj).cents4comp(1).pitch_in.dat{2}];    
    
    gp.postbeh.control_dat.pert_resp(isubj).cents4comp(1).temp.dat=-gp.postbeh.post_beh_data.control_dat.control_dat.pert_resp(isubj).cents4comp(1).pitch_in.dat{1};
    gp.postbeh.control_dat.pert_resp(isubj).cents4comp(1).abspitch_in.dat = [gp.postbeh.control_dat.pert_resp(isubj).cents4comp(1).temp.dat ; gp.postbeh.control_dat.pert_resp(isubj).cents4comp(1).pitch_in.dat{2}];    
