...
if yes_reload || ~exist('num','var')
  clear all
 % [num, txt,raw]=xlsread('cTBS_info_files/pre-post-sham.xls');
 % [num, txt,raw]=xlsread('cTBS_info_files/pre-post-beh.xls');
  [num, txt,raw]=xlsread('cTBS_info_files/pre-post-cereb.xls');
...
cd ..
cd /data/bil-mb4/zarinah-data/cerebellar-data/pitch-pert-cTBS/cTBS_data/data_analysis/cerebellarTBS/groupdata


%  save('pre_sham','patient_dat');
%  save('post_sham','control_dat');
 
%  save('pre_beh','patient_dat');
%  save('post_beh','control_dat');
  
 save('pre_cereb','patient_dat');
 save('post_cereb','control_dat');
